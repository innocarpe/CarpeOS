...
**최신 패키지:** [`@innocarpe/carpeos@6.6.0`](https://www.npmjs.com/package/@innocarpe/carpeos)
([변경 기록](CHANGELOG.md) · [`v6.6.0`](https://github.com/innocarpe/CarpeOS/releases/tag/v6.6.0)).
...
재현이 중요하면 버전 고정: `npm i -g @innocarpe/carpeos@6.6.0`.
...
**공개 패키지:** [`@innocarpe/carpeos@6.6.0`](https://www.npmjs.com/package/@innocarpe/carpeos)
(`v6.6.0` · [CHANGELOG](CHANGELOG.md)). npm 설치는 호스티드 배포나 live Product 4
