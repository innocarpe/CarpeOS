...
**최신 패키지:** [`@innocarpe/carpeos@6.7.5`](https://www.npmjs.com/package/@innocarpe/carpeos)
([변경 기록](CHANGELOG.md) · [`v6.7.5`](https://github.com/innocarpe/CarpeOS/releases/tag/v6.7.5)).
...
재현이 중요하면 버전 고정: `npm i -g @innocarpe/carpeos@6.7.5`.
...
현재 npm 패키지는 **`@innocarpe/carpeos@6.7.5`** (`v6.7.5`)입니다. adjudication + retrieval
...
**공개 패키지:** [`@innocarpe/carpeos@6.7.5`](https://www.npmjs.com/package/@innocarpe/carpeos)
(`v6.7.5` · [CHANGELOG](CHANGELOG.md)). npm 설치는 호스티드 배포나 live Product 4
