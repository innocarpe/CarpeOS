...
rm -rf "${ROOT}/.claude/skills/carpeos-pr" "${ROOT}/.agents/skills/carpeos-pr" "${ROOT}/.gjc/skills/carpeos-pr"
...
echo ""
echo "carpeos-pr skill installed for Claude Code, Codex/agents, Grok Build, and Gajae Code/GJC."
