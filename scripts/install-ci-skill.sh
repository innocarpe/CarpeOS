...
rm -rf "${ROOT}/.claude/skills/carpeos-ci" "${ROOT}/.agents/skills/carpeos-ci" "${ROOT}/.gjc/skills/carpeos-ci"
...
echo ""
echo "carpeos-ci skill installed for Claude Code, Codex/agents, Grok Build, and Gajae Code/GJC."
