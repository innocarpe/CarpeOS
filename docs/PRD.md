...
| **6.0 (planned)** | Can a post-capture Agentic Layer (DeepSeek V4 Flash only) form grounded, typed, graph-linked knowledge under deterministic gates without LLM in capture? | [PRD-v6.md](PRD-v6.md) | [product-6.0.0.md](maintainers/product-6.0.0.md) — architecture freeze ADR 0017; implementation phased P0–P6 |
