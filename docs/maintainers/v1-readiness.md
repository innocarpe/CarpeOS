...
| # | Gate | Status (as of 0.1.2) | Evidence / notes |
| --- | --- | --- | --- |
...
| G5 | MCP smoke (list / search / context-pack) documented + CI or scripted gate | **partial** | Guides exist; tighten a named smoke script/CI step before 1.0 |
