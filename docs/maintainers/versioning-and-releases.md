...
Current public release: **`@innocarpe/carpeos@6.7.5`** (quality DoD baseline #2 + prefer triage match; cite belt from 6.7.4; quality substrate from 6.7.0). See [product-6.0.0.md](product-6.0.0.md).
