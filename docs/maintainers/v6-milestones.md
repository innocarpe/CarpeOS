...
| **V6-P5** Draft Claims | decision/fact_candidate drafts; accept = 0 auto | Claim fixtures + materialize tests | **in progress** (this branch) |
...
| **npm 6.3.0** | P5 draft Claims | fact_candidate/decision draft Claims; zero auto AcceptanceDecision | pending cut |
