...
**Latest package:** [`@innocarpe/carpeos@6.7.1`](https://www.npmjs.com/package/@innocarpe/carpeos)
([CHANGELOG](CHANGELOG.md) · [`v6.7.1`](https://github.com/innocarpe/CarpeOS/releases/tag/v6.7.1)).
...
`npm i -g @innocarpe/carpeos@6.7.1`. See [CHANGELOG.md](CHANGELOG.md).
...
Current npm package is **`@innocarpe/carpeos@6.7.1`** (`v6.7.1`): operator loop through
...
**Public package:** [`@innocarpe/carpeos@6.7.1`](https://www.npmjs.com/package/@innocarpe/carpeos)
(`v6.7.1` · [CHANGELOG](CHANGELOG.md)). npm install does **not** imply hosted deploy or
