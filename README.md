...
**Latest package:** [`@innocarpe/carpeos@6.6.3`](https://www.npmjs.com/package/@innocarpe/carpeos)
([CHANGELOG](CHANGELOG.md) · [`v6.6.3`](https://github.com/innocarpe/CarpeOS/releases/tag/v6.6.3)).
...
`npm i -g @innocarpe/carpeos@6.6.3`. See [CHANGELOG.md](CHANGELOG.md).
...
Current npm package is **`@innocarpe/carpeos@6.6.3`** (`v6.6.3`): operator loop through
...
**Public package:** [`@innocarpe/carpeos@6.6.3`](https://www.npmjs.com/package/@innocarpe/carpeos)
(`v6.6.3` · [CHANGELOG](CHANGELOG.md)). npm install does **not** imply hosted deploy or
