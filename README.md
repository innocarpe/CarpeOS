...
**Latest package:** [`@innocarpe/carpeos@6.2.0`](https://www.npmjs.com/package/@innocarpe/carpeos)
([CHANGELOG](CHANGELOG.md) · [`v6.2.0`](https://github.com/innocarpe/CarpeOS/releases/tag/v6.2.0)).
...
`npm i -g @innocarpe/carpeos@6.2.0`. See [CHANGELOG.md](CHANGELOG.md).
...
Current npm package is **`@innocarpe/carpeos@6.2.0`** (`v6.2.0`): operator loop through
...
Agentic P5–P6 (draft Claims, GraphRAG ranking) not claimed in 6.2.0 (P3 precision +
P4 graph density shipped in 6.1/6.2).

---

## What works today

**Public package:** [`@innocarpe/carpeos@6.2.0`](https://www.npmjs.com/package/@innocarpe/carpeos)
(`v6.2.0` · [CHANGELOG](CHANGELOG.md)). npm install does **not** imply hosted deploy or
