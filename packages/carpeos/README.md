...
npm install -g @innocarpe/carpeos@6.7.5
...
The current public release is **`6.7.5`** (grounded extract cite belt + agentic quality substrate + HITL-free Agentic Layer with
